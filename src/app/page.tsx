  ...
  return (
    ...
    <main className="flex min-h-screen flex-col items-center p-24">
      <div className='max-w-6xl h-full px-4 mx-auto sm:px-6'>
        <div className='flex flex-col h-96 justify-evenly items-center text-white bg-cover bg-center' style={{backgroundImage: "url('https://images.unsplash.com/photo-1604328471151-b52226907017?q=80&w=2671&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"}}>
