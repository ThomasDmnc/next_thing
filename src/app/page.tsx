  ...
  return (
    ...
    <main className="flex min-h-screen flex-col items-center p-24">
      <div className='max-w-6xl h-full px-4 mx-auto sm:px-6'>
        <div className='flex flex-col h-96 justify-evenly items-center text-background bg-hero-pattern bg-cover bg-center'>
          ...
          <Link
            href="/reservations"  
          >
            <button className="bg-secondary rounded-md p-4 font-bold text-background hover:bg-secondaryDark">Book a table</button>
          </Link>
