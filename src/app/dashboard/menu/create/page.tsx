    ...
    return (
        ...
        <main className="flex min-h-screen flex-col w-screen items-start py-8 md:py-12 lg:py-12 px-4 md:px-12">
            ...
            >
                ...
                <input required name='name' type='text' className='w-full h-full p-2 border-2 border-blue-300 rounded mb-4' placeholder='Name of the menu item' />
                <label className='font-bold text-blue-600 text-lg py-2'>Description</label>
                <textarea required name='description' className='w-full h-full p-2 border-2 border-blue-300 rounded mb-4' placeholder='Description of the menu item' />
                <label className='font-bold text-blue-600 text-lg py-2'>Ingredients</label>
                <textarea required name='ingredients' className='w-full h-full p-2 border-2 border-blue-300 rounded mb-4' placeholder='Ingredients of the menu item' />
                <label className='font-bold text-blue-600 text-lg py-2'>Category</label>
                <select required name='category' className='w-full h-full p-2 border-2 border-blue-300 rounded mb-4'>
                ...
                <input required name='price' type="number" step="0.01" min="0" className='w-full h-full p-2 border-2 border-blue-300 rounded mb-4' placeholder='Price of the menu item' />
                ...
                <select required name='availability' className='w-full h-full p-2 border-2 border-blue-300 rounded mb-4'>
